...
const cardDetails = [
  {
    ...
    year: '2025',
    imageUrl: 'images/Snapshoot Portfolio desktop1.png',
    ...
    technology: 'Back End Dev',
    year: '2025',
    imageUrl: 'images/Snapshoot Portfolio desktop2.png',
    ...
    technology: 'Back End Dev',
    year: '2025',
    imageUrl: 'images/Snapshoot Portfolio desktop 3.png',
    description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essent",
    languages: ['html', 'css', 'javascript', 'github', 'ruby', 'Bootstraps'],
    liveLink: 'https://www.linkedin.com/in/isabella-otoo-935901146/',
    sourceCode: 'https://github.com/Bellagirl-maker/',
    ...
    technology: 'Back End Dev',
    year: '2025',
    imageUrl: 'images/Snapshoot Portfolio desktop 4.png',
    description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essent",
    languages: ['html', 'css', 'javascript', 'github', 'ruby', 'Bootstraps'],
    liveLink: 'https://www.linkedin.com/in/isabella-otoo-935901146/',
    sourceCode: 'https://github.com/Bellagirl-maker/',
